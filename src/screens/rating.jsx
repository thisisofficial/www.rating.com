...
import './styles.css'
import {Ratin_button} from '../components/ratin_button'
        ...
        <div className='box'>
            <div className='row'>
                <div className='circle'>
                    <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg" className='star'>
            ...
            <div className='row'>
                ...
                <p className='text'> Please let us know how we did with your suppor request. All feedback is appreciated to help us improve our offering!</p>
            </div>
            <div className='row'>
                <ul>
                    <li><Ratin_button num={1} curNum={num}></Ratin_button></li>
                    <li><Ratin_button num={2} curNum={num}></Ratin_button></li>
                    <li><Ratin_button num={3} curNum={num}></Ratin_button></li>
                    <li><Ratin_button num={4} curNum={num}></Ratin_button></li>
                    <li><Ratin_button num={5} curNum={num}></Ratin_button></li>
                </ul>
            </div>
            <div className='row'>
                <Link to={{pathname:`/thanks/${num}`, state:{ratingScore:`${num}`}}}>
                    <div className='submitButton'>
                        <p className='centered'>Submit</p>
                    </div>
                </Link>
